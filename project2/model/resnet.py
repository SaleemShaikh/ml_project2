""" This module implements the ResNet.
"""
...
def resnet34(inputShape, include_top=True, input_tensor=None, nb_class=10):
...
def resnet34orig(inputShape, include_top=True, input_tensor=None, nb_class=10):
    """ ResNet for input images (patches) of size 16x16. The output
    layer consists of 1 neuron with logistic activation function (1 = signal, 0 = background).
